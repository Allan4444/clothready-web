  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 140, height: 'auto' }}>
        ...
        <line x1="35" y1="55" x2="32" y2="85" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/>
        <line x1="125" y1="55" x2="128" y2="85" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 190" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 140, height: 'auto' }}>
        ...
        <line x1="77" y1="70" x2="83" y2="70" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="82" x2="83" y2="82" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="94" x2="83" y2="94" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="106" x2="83" y2="106" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="118" x2="83" y2="118" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="130" x2="83" y2="130" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
        <line x1="77" y1="142" x2="83" y2="142" stroke="rgba(255,255,255,0.25)" strokeWidth="1"/>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 185" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 140, height: 'auto' }}>
        ...
        <circle cx="80" cy="62" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
        <circle cx="80" cy="78" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
        <circle cx="80" cy="94" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
        <circle cx="80" cy="110" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
        <circle cx="80" cy="126" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
        <circle cx="80" cy="142" r="2.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1" fill="none"/>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 140, height: 'auto' }}>
        ...
        <line x1="34" y1="55" x2="126" y2="55" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
        <line x1="34" y1="70" x2="126" y2="70" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
        <line x1="34" y1="85" x2="126" y2="85" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
        <line x1="34" y1="100" x2="126" y2="100" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
        <line x1="34" y1="115" x2="126" y2="115" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
        <line x1="34" y1="130" x2="126" y2="130" stroke="rgba(255,255,255,0.07)" strokeWidth="1"/>
      </svg>
    ),
  },
]
  ...
  return (
    <main style={{ background: '#0a0a0a', color: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 2rem 6rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1.5rem' }}>
          {products.map(({ name, file, svg }) => (
            <div key={name} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '1rem 1.25rem 1.4rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                ...
                <p style={{ color: '#555', fontSize: '0.78rem', margin: 0 }}>Spec sheet · BOM · Measurements</p>
        ...
        <div style={{ marginTop: '4rem', textAlign: 'center', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '3rem 2rem' }}>
          ...
          <p style={{ color: '#777', fontSize: '0.9rem', lineHeight: 1.7, maxWidth: 500, margin: '0 auto 2rem' }}>
      ...
      <style>{`
        ...
        .tp-btn:hover { background: rgba(255,71,87,0.22); }
      `}</style>
    </main>
  )
}
